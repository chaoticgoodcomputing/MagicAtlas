...
/// </summary>
/// <remarks>
/// Serial single-pass; the parser is logically pure, so a future move to
/// <c>AsParallel</c> stays drop-in.
///
/// <para>Promoted verbatim from tests/magic-ast-tests/Flows/MagicAstTriage/Steps/ParseCorpusStep.cs
