...
/// is owned by Flowthru's <c>HttpStorageMedium</c> (wired via <c>UseHttp</c> in the harness), so this
/// step is a pure transform: no <see cref="HttpClient"/>, no file IO, no manual-curl precondition.
/// </summary>
/// <remarks>
...
/// 510 MB wire payload.
///
/// <para>Promoted verbatim from tests/magic-ast-tests/Flows/InteractionTriage/Steps/FetchCombosStep.cs
/// (namespace fixed to MagicAtlas.Flows.*) so the shippable library can regenerate combos.json.</para>
/// </remarks>
[FlowthruStep]
