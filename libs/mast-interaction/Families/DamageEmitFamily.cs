...
public sealed class DamageEmitFamily : IPortFamily
{
  ...
  {
    if (structure.Side != PortSide.Emit || structure.Stem != "damage" || structure.Attr("manner") is null)
      return null;
    return Join("emit", "damage", structure.Attr("manner"), structure.Attr("recipient"));
  }
