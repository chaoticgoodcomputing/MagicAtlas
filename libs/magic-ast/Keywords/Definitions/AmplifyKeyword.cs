...
///
/// <para>
/// The <see cref="Definition"/> is the verbatim former <c>KeywordDefinitions.Amplify</c>
/// (including its inlined <c>ParseIntValue</c> guard); the <see cref="Combinator"/> is
/// the verbatim former <c>OracleParsers.Amplify</c>.
/// </para>
/// </summary>
[Keyword]
public sealed class AmplifyKeyword : IKeyword
{
  /// <inheritdoc/>
