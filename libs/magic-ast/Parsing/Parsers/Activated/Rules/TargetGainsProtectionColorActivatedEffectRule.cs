...
/// <summary>
/// Activated-ability analogue of
/// <see cref="MagicAST.Parsing.Parsers.Spell.Rules.TargetGainsProtectionColorRule"/>:
/// recognises the "gains protection from the color of your choice UEOT" interior of an
/// activated ability —
///   "Target creature you control gains protection from the color of your choice until end of turn."
///
/// This is the effect half of Mother of Runes ("{T}: Target creature you control gains
/// protection from the color of your choice until end of turn."). The spell rule only
/// fires on the spell-parsing path, so the same shape reached via an activated ability's
/// post-colon effect fragment needs its own recognizer here.
///
...
public sealed class TargetGainsProtectionColorActivatedEffectRule : IActivatedEffectRule
{
