...
/// <summary>
/// "This creature can't be blocked this turn." — activated ability effect that
/// grants the controlling creature full unblockability until end of turn.
///
...
/// <list type="bullet">
///   <item><description><see cref="CantBeBlockedEffect.Target"/> = <c>Self</c> — the
///   creature that pays the cost is the one that becomes unblockable.</description></item>
