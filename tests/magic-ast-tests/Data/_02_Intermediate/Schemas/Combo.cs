...
/// triage actually uses: the cards (name + Scryfall <c>oracleId</c>), the popularity ranking signal,
/// the color identity, and the produced results (prose). This is the work-list unit: each combo is
/// a candidate the interaction engine should be able to reconstruct.
/// </summary>
[FlowthruSchema]
